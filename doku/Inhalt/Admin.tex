...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../Bilder/Admin/AdminHome}
\caption[AdminHome]{Admin-Oberfläche}
\label{fig:AdminHome}
\end{figure}
\newpage
Der Anwender hat die Möglichkeit sich anzumelden oder zu registrieren.
\subsubsection*{Registrieren}
\href{http://193.175.199.115/StudMapAdmin/Account/Register}{http://193.175.199.115/StudMapAdmin/Account/Register}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../Bilder/Admin/AdminRegistrierung}
\caption[AdminRegistrierung]{Registrierung eines Anwenders}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../Bilder/Admin/AdminAnmelden}
\caption[AdminRegistrierung]{Anmeldung eines Anwenders}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../Bilder/Admin/AdminMaps}
\caption[AdminMaps]{Kartenübersicht}
\label{fig:AdminMaps}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../Bilder/Admin/AdminFloors}
\caption[AdminFloors]{Stockwerkübersicht}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../Bilder/Admin/AdminLayer}
\caption[AdminLayer]{Kartenwerk mit Graph}
\label{fig:AdminLayer}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../Bilder/Admin/AdminNodeInfo}
\caption[AdminNodeInfo]{Knoteninformationen zu einem Knoten}
